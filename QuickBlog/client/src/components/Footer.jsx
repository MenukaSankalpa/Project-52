    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3 '>
        ...
        className='flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500'>
            ...
            <div>
                ...
                <p className='max-w-[410px] mt-6'>Write. Share. Inspire.Your story matters.Powered by creativity.Blog your thoughts.Speak your mind.Where words come alive.
                    A place to think out loud.Simple. Smart. Blogging.Start writing today.
                </p>
            </div>
